...
class GaussianModel:
    ...
    def restore(self, model_args, training_args):
        ...
        try:
            ...
            print("Warning: optimizer state is incompatible with semantic parameters, using freshly initialized optimizer state.")
    ...
    def training_setup(self, training_args):
        ...
        l = [
            ...
            {'params': [self._semantic], 'lr': training_args.feature_lr, "name": "semantic"},
    ...
    def densification_postfix(self, new_xyz, new_features_dc, new_features_rest, new_semantic, new_opacities, new_scaling, new_rotation, new_tmp_radii):
        d = {"xyz": new_xyz,
    ...
    def densify_and_split(self, grads, grad_threshold, scene_extent, semantic_stats=None, uncertainty_threshold=0.35, semantic_densify_max_ratio=0.05, N=2):
        ...
        self.densification_postfix(new_xyz, new_features_dc, new_features_rest, new_semantic, new_opacity, new_scaling, new_rotation, new_tmp_radii)
