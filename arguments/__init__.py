...
class ModelParams(ParamGroup): 
    def __init__(self, parser, sentinel=False):
        ...
        self.semantic_dir = ""
        self.semantic_dim = 8
        self.use_dino_semantic_init = False
        self.dino_feature_dir = ""
        self.dino_init_max_views = 8
        self.dino_init_chunk_size = 65536
        self.dino_init_reduction_samples = 20000
        self._resolution = -1
...
class OptimizationParams(ParamGroup):
    def __init__(self, parser):
        ...
        self.use_boundary_weighted_semantic_loss = False
        self.boundary_loss_weight = 2.0
        self.boundary_kernel_size = 9
        ...
        self.semantic_densify_max_ratio = 0.05
